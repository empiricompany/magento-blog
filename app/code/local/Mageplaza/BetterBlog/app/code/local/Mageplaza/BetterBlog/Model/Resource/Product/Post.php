 ...
 * @author      Sam
 */
class Mageplaza_BetterBlog_Model_Resource_Product_Post extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('mageplaza_betterblog/product_post', 'post_id');
    }
     ...
     * @param array $data
     * @return Mageplaza_BetterBlog_Model_Resource_Tag_Product
     * @author Sam
     */
    public function saveProductRelationNO($tag, $data)
    {
        if (!is_array($data)) {
            $data = array();
        }
